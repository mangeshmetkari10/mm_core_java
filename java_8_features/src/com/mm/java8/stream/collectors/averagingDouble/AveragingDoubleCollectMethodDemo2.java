...
public class AveragingDoubleCollectMethodDemo2 {
	...
	public static void main(String[] args) {
		...
		Double count = students.stream().collect(Collectors.averagingDouble(student -> student.rollNumber));
		System.out.println("Roll Number averge : " + count);
