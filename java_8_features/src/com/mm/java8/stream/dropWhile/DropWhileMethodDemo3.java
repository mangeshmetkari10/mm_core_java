...
public class DropWhileMethodDemo3 {
	...
	public static void main(String[] args) {
		...
		List<Student> nameLengthGreaterThan3 = students.stream().dropWhile(predicate).collect(Collectors.toList());
		System.out.println("Drop students name length > 3: " + nameLengthGreaterThan3);
